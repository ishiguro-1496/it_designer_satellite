  ...
  <div class="main_content_wrap">
    <div class="main_content_inner">
      ...
      <div class="prev_next_btn">
         ...
         <?php previous_post_link('%link', '<img src="'. get_template_directory_uri().'/static/imgages/arrow_left.svg" alt="PREV" width="7"/>'); ?>

        <?php next_post_link('%link', '<img src="'. get_template_directory_uri().'/static/imgages/arrow_right.svg" alt="NEXT" width="7"/>'); ?>
